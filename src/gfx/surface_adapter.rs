// Hack version of vulkano-win 0.7.2.
// Using vulkano-win directry raised compile error:
// no method named `build_vk_surface` found for type `winit::WindowBuilder` in the current scope
...
pub fn build_surface(window: &winit::Window, instance: Arc<Instance>) -> Result<Arc<Surface>, SurfaceCreationError> {
